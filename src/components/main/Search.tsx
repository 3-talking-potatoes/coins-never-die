...
const Search = () => {
  ...
  return (
    <div className="mb-1 w-[30rem] sm:w-[34rem] md:w-[36rem] lg:w-[50rem] xl:w-[64rem] flex-none">
      <div className="h-[44px] flex border-2 px-2 sm:px-2 lg:px-4 border-yellow-200 dark:border-purple-200 rounded-lg bg-white ">
        <input
      ...
      {hasText ? (
        <ul className="z-10 absolute w-[30rem] sm:w-[34rem] md:w-[36rem] lg:w-[50rem] xl:w-[64rem] items-center justify-start border-2 border-yellow-200 dark:border-purple-200 rounded-lg bg-white">
