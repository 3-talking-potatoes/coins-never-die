...
export default function useSignUpForm() {
  ...
  const disabledButtonStyle =
    "w-[17rem] md:w-[20rem] h-12 font-[Galmuri7] text-2xl mt-4 border-solid border-[3px] border-black bg-grey rounded-lg text-slate-100 cursor-not-allowed";
  const activeButtonStyle =
    "w-[17rem] md:w-[20rem] h-12 font-[Galmuri7] text-2xl mt-4 border-solid border-[3px] bg-yellow-200 dark:bg-purple-200 border-black rounded-lg hover:bg-yellow-100 hover:dark:bg-purple-100 hover:text-3xl";
